...
\affil{School of CIT, Technical University of Munich, Germany}
\date{Summer 2025}
\maketitle
...
\item[-] Lecture 10 -- Arnoldi procedures and Krylov subspace methods for non-symmetric eigenvalue problems\vspace{-.15cm}
\item[-] Lecture 11 -- Krylov subspace methods for non-symmetric linear systems\vspace{-.15cm}
\item[-] Lecture 12 -- Lanczos procedures and Krylov subspace methods for symmetric eigenvalue problems\vspace{-.15cm}
\item[-] Lecture 13 -- Krylov subspace methods for symmetric linear systems\vspace{-.15cm}
\item[-] Lecture 14 -- Preconditioned iterative methods for linear systems\vspace{-.15cm}
\item[-] Lecture 15 -- Preconditioners\vspace{-.15cm}
\end{itemize}
