...
\begin{enumerate}
\item Code a function \mintinline{julia}{BCGS} with the option to use either of CGS, CGS2, MGS, CholQR and CholQR as IntraOrtho. 
\item Code a function \mintinline{julia}{BCGS2} with the option to use either of CGS, CGS2, MGS, CholQR and CholQR as IntraOrtho. 
\item Code a function \mintinline{julia}{BMGS} with the option to use either of CGS, CGS2, MGS, CholQR and CholQR as IntraOrtho. 
