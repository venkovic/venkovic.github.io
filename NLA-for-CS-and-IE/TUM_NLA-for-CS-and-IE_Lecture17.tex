...
\begin{itemize}\normalsize
\item[-] Returns the QR factorization of an $m\times n$ matrix $X$ by \textbf{orthogonalizing vectors}, \textbf{one-at-a-time}, against previously orthnogonalized vectors.
\end{itemize}
...
\end{center}
\vspace{.1cm}
\textbf{All $s$ vectors} of the block treated by IntraOrtho are \textbf{simultaneaously available}.\vspace{.1cm}\\
