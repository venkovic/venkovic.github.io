...
\end{itemize}
%\item Recent and ongoing research efforts (see {\color{blue}{\underline{\href{https://venkovic.github.io/research}{venkovic.github.io/research}}}}):%
\item Recent and ongoing research efforts (see \href{https://venkovic.github.io/research}{\color{blue}{\underline{venkovic.github.io/research}}}):
...
\begin{itemize}
\item[-] \textbf{Lecture slides}, \textbf{Julia notebooks} and \textbf{problem sets} uploaded gradually on \href{https://www.moodle.tum.de/}{\color{blue}{\underline{Moodle}}}, throughout the semester.\\
Content also uploaded at \href{https://venkovic.github.io/NLA-for-CS-and-IE}{\color{blue}{\underline{venkovic.github.io/NLA-for-CS-and-IE}}}.
...
\includegraphics[height=1.8cm]{images/Bai2021.jpg}
\end{minipage}
\hspace{-.8cm}
\begin{minipage}{0.75\textwidth}
...
\end{minipage}\vspace{.3cm}
\item[-]\begin{minipage}{0.2\textwidth}\vspace{.3cm}
\includegraphics[height=1.65cm]{images/Higham2002.jpg}
\end{minipage}
\hspace{-.8cm}
\begin{minipage}{0.75\textwidth}
