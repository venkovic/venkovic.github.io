...
\begin{itemize}
\item[-] \texttt{Lecture 01}: Essentials of linear algebra\vspace{.04cm}
\item[-] \texttt{Lecture 02}: Essentials of the Julia language\vspace{.04cm}
\item[-] \texttt{Lecture 03}: Floating-point arithmetic and error analysis\vspace{.04cm}
\item[-] \texttt{Lecture 04}: Direct methods for dense linear systems\vspace{.04cm}
\item[-] \texttt{Lecture 05}: Sparse data structures and basic linear algebra subprograms\vspace{.04cm}
\item[-] \texttt{Lecture 06}: Introduction to direct methods for sparse linear systems\vspace{.04cm}
\item[-] \texttt{Lecture 07}: Orthogonalization and least squares problems\vspace{.04cm}
\item[-] \texttt{Lecture 08}: Basic iterative methods for linear systems\vspace{.04cm}
\item[-] \texttt{Lecture 09}: Basic iterative methods for eigenvalue problems\vspace{.04cm}
\item[-] \texttt{Lecture 10}: Locally optimal block preconditioned conjugate gradient\vspace{.04cm}
\item[-] \texttt{Lecture 11}: Arnoldi and Lanczos procedures\vspace{.04cm}
\item[-] \texttt{Lecture 12}: Krylov subspace methods for linear systems\vspace{.04cm}
\item[-] \texttt{Lecture 13}: Multigrid methods\vspace{.04cm}
\item[-] \texttt{Lecture 14}: Preconditioned iterative methods for linear systems\vspace{.04cm}
\item[-] \texttt{Lecture 15}: Restarted Krylov subspace methods\vspace{.04cm}
\item[-] \texttt{Lecture 16}: Elements of randomized numerical linear algebra\vspace{.04cm}
\item[-] \texttt{Lecture 17}: Introduction to communication-avoiding algorithms
\end{itemize}
\end{itemize}
%\vfill
...
\begin{itemize}
\item[-] \texttt{Lecture E1}: More on eigensolvers, e.g., FEAST, Jacobi-Davidson, ...\vspace{.04cm}
\item[-] \texttt{Lecture E2}: Matrix function evaluation in Krylov subspaces\vspace{.04cm}
...
\begin{itemize}
\item \textbf{Take over exam}:\vspace{.2cm}
\begin{center}
\fbox{\begin{minipage}{0.65\textwidth}\begin{center}
\textbf{10:00$\,$-11:30}\\
